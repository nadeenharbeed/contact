...
<head>
  ...
  <title> News Web | @yield('title') </title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="iframe.html" class="nav-link">
              <i class="nav-icon fas fa-sign-out-alt"></i> <!-- to change icon -->
              <p>Logout</p>
            </a>
          </li>
            <li class="nav-item">
...
@yield('contat')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; {{ now()->year }} - {{ now()->year +1}} <a href="{{ route('footer') }}">{{ env('APP_NAME') }}</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Version</b> {{ env('APP_Version') }} <!--to read version from env page -->
    </div>
  </footer>
